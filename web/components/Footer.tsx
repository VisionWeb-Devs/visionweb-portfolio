...
const Footer = ({
  ...
  return (
    <footer id="contact" data-nav-theme="dark" className="bg-surface-alt px-4 xl:px-12 py-12">
      <div data-nav-theme="light" className="bg-surface rounded-3xl uppercase text-on-surface px-4 xl:px-12 xl:py-9 py-6 flex flex-col gap-8 xl:gap-20">
